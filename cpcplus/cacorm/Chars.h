...
constexpr byte Char_Line = 0x5A;
constexpr byte Char_Line_Normal = 0x5A;
constexpr byte Char_Line_RightBottom = 0x5A;
constexpr byte Char_Line_LeftBottom = 0x5B;
constexpr byte Char_Line_RightTop = 0x5C;
constexpr byte Char_Line_LeftTop = 0x5D;
constexpr byte Char_Line_Left = 0x5E;
constexpr byte Char_Line_Right = 0x5F;
constexpr byte Char_Line_Top = 0x60;
constexpr byte Char_Line_Bottom = 0x61;
constexpr byte Char_Line_Red = 0x62;
constexpr byte Char_Color = 0x6A;
