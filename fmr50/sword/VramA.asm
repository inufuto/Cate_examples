...
DrawSprite_: public DrawSprite_
	push ax | push cx | push dx | push bx | push si | push di | push bp
		xchg al,dl
		mov ch,VramWidth*2
		mul ch
		...
		do
			...
			dec ch
		while nz | wend
    pop bp | pop di | pop si | pop bx | pop cx | pop dx | pop ax
ret
