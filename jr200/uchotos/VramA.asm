...
cseg
ColorSource:
defb 2,Char_Ladder,$46 ; Ladder
defb 1,Char_Floor,$42 ; Floor
defb 4,Char_Item,$46 ; Item
defb 4,Char_Fire,$42 ; Fire
defb 20,Char_Monster,$45 ; Monster
...
InitVram: public InitVram
    ...
    ldx #CharPattern+CharHeight*Ptn_Ladder | stx <pSource
    ldx #CharGen0+CharHeight*(Char_Ladder) | stx <pDestination
    ldab #Char_End0-Char_Ladder
    bsr CopyBytes

    ldx #CharPattern+CharHeight*Ptn_Oneup | stx <pSource
    ldx #CharGen1+CharHeight*(Char_Oneup-$80) | stx <pDestination
    ldab #Char_End1-Char_Oneup
    bsr CopyBytes
rts
