...
cseg
ColorSource:
defb 1,Char_Cent,$47 ; Cent
defb 4,Char_Wall,$41 ; Wall
defb 4,Char_Box,$42 ; Box
defb 4,Char_Item,$46 ; Item
defb 4,Char_Ball,$47 ; Ball
defb 4,Char_Oneup,$44 ; Oneup
defb 4,Char_Remain,$45 ; Remain
defb 4,Char_Man,$45 ; Man
defb 4,Char_Sword,$45 ; Sword
defb 16,Char_Monster,$47 ; Monster
defb 0
InitVram: public InitVram
    ...
    ldx #CharPattern+CharHeight*Ptn_Cent | stx <pSource
    ldx #CharGen0+CharHeight*(Char_Cent) | stx <pDestination
    ldab #Char_End0-Char_Cent
    bsr CopyBytes

    ; ldx #CharPattern+CharHeight*Pattern_Stair | stx <pSource
    ; ldx #CharGen1+CharHeight*(Char_Stair-$80) | stx <pDestination
    ; ldab #Char_End1-Char_Stair
    ; bsr CopyBytes
rts
