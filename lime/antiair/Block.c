...
constexpr byte Ground_TimeMax = ((CoordMask << 5) | 0x10);
                    ...
                    case Type_TimeBomb:
                        {
                            ptr<byte> pGround;
                            pGround = Ground + x;
                            *pGround = (*pGround & Ground_BlockMask) | Ground_LeftBomb | Ground_TimeMax;
                            ++pGround;
                            *pGround = (*pGround & Ground_BlockMask) | Ground_RightBomb | Ground_TimeMax;
                            BackgroundChanged = true;
                        }
                        break;
                    }
