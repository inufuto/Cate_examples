...
constexpr byte Char_Wall = 80;
constexpr byte Char_Dot = 96;
constexpr byte Char_Color = 100;
constexpr byte Char_Food = 100;
constexpr byte Char_Remain = 104;
constexpr byte Char_End = 108;
