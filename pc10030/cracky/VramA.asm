...
cseg
PaletteValues:
defb	00h, 00h, 8ah, 01h, 07h, 00h, 0a6h, 01h
defb	38h, 00h, 0f8h, 01h, 3fh, 00h, 0ffh, 01h
defb	00h, 00h, 0dbh, 00h, 26h, 00h, 95h, 00h
defb	18h, 00h, 10h, 01h, 77h, 00h, 6dh, 01h
ColorTable:
defb 64, 7h ; Ascii
defb 16, 0eh ; Logo
defb 8, 0fh ; CrackedFloor
defb 1, 0fh ; HardFloor
defb 2, 0ah ; Ladder
defb 4, 0eh ; Item
defb 0
