...
void InitFloor()
{
    ...
    //             byte cell = *pMap;
    //             if ((cell & Cell_Visible) != 0) {
    //                 pVVram = VPut(pVVram, Char_Wall_C);
    //                 {
    //                     byte c = (cell & Cell_TopWall) != 0 ? Char_Wall_H : Char_Space;
    //                     repeat (2) {
    ...
    //                 {
    //                     byte c = (cell & Cell_LeftWall) != 0 ? Char_Wall_V : Char_Space;
    //                     repeat (2) {
    //                         pVVram = VPut(pVVram, c);
    //                         pVVram += VVramWidth - 1;
    //                     }
    ...
    //                     repeat (2) {
    //                         repeat (2) {
    //                             pVVram = VPut(pVVram, *p); ++p;
    //                         }
    //                         pVVram += VVramWidth - 2;
    //                     }
    //                     pVVram += 2 - VVramWidth * 2;
    //                 }
    //                 {
    //                     byte c = (cell & Cell_RightWall) != 0 ? Char_Wall_V : Char_Space;
    //                     repeat (2) {
    //                         pVVram = VPut(pVVram, c);
    //                         pVVram += VVramWidth - 1;
    //                     }
    ...
    //                 pVVram = VPut(pVVram, Char_Wall_C);
    //                 {
    //                     byte c = (cell & Cell_BottomWall) != 0 ? Char_Wall_H : Char_Space;
    //                     repeat (2) {
    //                         pVVram = VPut(pVVram, c);
    //                     }
    //                 }
    //                 pVVram = VPut(pVVram, Char_Wall_C);
    //                 pVVram += -VVramWidth * 3 - 1;
    //             }
    //             else {
    //                 pVVram += VVramWidth + 1;
    //                 repeat (3) {
    ...
    //                     pVVram += VVramWidth - 3;
    //                 }
    //                 pVVram += 2 - VVramWidth * 4;
    //             }
    //             ++pMap;
    //         }
    //         pVVram += VVramWidth * 3 - 24;
    //     }
    // }
    ShowMonsters();
    ShowKnives();
