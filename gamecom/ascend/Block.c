...
static void Draw(ptr<Block> pBlock)
{
    static const byte[] Chars = {
        ...
        //
        Char_Space_LeftUpperBlock1, Char_Space_RightUpperBlock1,
        Char_LeftUpperBlock_LeftLowerBlock1, Char_RightUpperBlock_RightLowerBlock1,
        Char_LeftLowerBlock_Space1, Char_RightLowerBlock_Space1,
        //
        ...
        //
        Char_Space_LeftUpperBlock3, Char_Space_RightUpperBlock3,
        Char_LeftUpperBlock_LeftLowerBlock3, Char_RightUpperBlock_RightLowerBlock3,
        Char_LeftLowerBlock_Space3, Char_RightLowerBlock_Space3,
        //
        Char_Space_LeftUpperBlock4, Char_Space_RightUpperBlock4,
        Char_LeftUpperBlock_LeftLowerBlock3, Char_RightUpperBlock_RightLowerBlock3,
        Char_LeftLowerBlock_Space4, Char_RightLowerBlock_Space4,
        //
        Char_Space_LeftUpperBlock5, Char_Space_RightUpperBlock5,
        Char_LeftUpperBlock_LeftLowerBlock3, Char_RightUpperBlock_RightLowerBlock3,
        Char_LeftLowerBlock_Space5, Char_RightLowerBlock_Space5,
        //
        ...
        //
        Char_Space_LeftUpperBlock7, Char_Space_RightUpperBlock7,
        Char_LeftUpperBlock_LeftLowerBlock7, Char_RightUpperBlock_RightLowerBlock7,
        Char_LeftLowerBlock_Space7, Char_RightLowerBlock_Space7,
    };
    byte y;
    y = pBlock->y - topY;
