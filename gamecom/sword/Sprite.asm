...
XRange equ CharWidth*VVramWidth-SpriteWidth+1
YRange equ CharHeight*VVramHeight-SpriteHeight+1
...
DrawSprites_: public DrawSprites_
    pushw rr0 | pushw rr8
        ...
        movw rr8,Sprites+unitSize*Sprite_End
        mov r0,InvalidPattern
        do
            subw rr8,unitSize
