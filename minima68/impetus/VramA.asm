...
cseg
PaletteValues:
defb	$00, $00, $00, $5f, $3f, $df, $ff, $00
defb	$00, $ff, $7f, $ff, $00, $ff, $00, $3f
defb	$df, $ff, $ff, $ff, $00, $ff, $ff, $ff
defb	$00, $00, $00, $df, $bf, $7f, $df, $00
defb	$3f, $9f, $00, $00, $bf, $df, $bf, $00
defb	$7f, $7f, $ff, $9f, $5f, $9f, $9f, $9f
...
StatusToVram_: public StatusToVram_
    psha | pshb
        ldx #Status_ | stx pStatus
        ldx pNextPage_ | stx pVram
        ldab #VramWidth*2
        do
            ldx pStatus | ldaa 0,x | inx | stx pStatus
            ldx pVram
            tsta
            if ne
                staa 0,x
