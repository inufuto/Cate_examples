ext SPrintC_, SPrintC_@Param0, SPrintC_@Param1
...
PrintDigitB:
    ...
    ldx pVram | stx SPrintC_@Param0
    stab SPrintC_@Param1
    jsr SPrintC_
    stx pVram
rts
...
PrintByteNumber3_: public PrintByteNumber3_
    psha | pshb
        ...
        ldaa #10 | staa num
        bsr PrintDigitB
        ldab value | addb #'0' | stab SPrintC_@Param1
        ldx pVram | stx SPrintC_@Param0
        jsr SPrintC_
    pulb | pula
rts
...
PrintNumber5_: public PrintNumber5_
    psha | pshb
        ...
        ldx #10 | stx num
        bsr PrintDigitW
        ldab value+1 | addb #'0' | stab SPrintC_@Param1
        ldx pVram | stx SPrintC_@Param0
        jsr SPrintC_
    pulb | pula
rts
