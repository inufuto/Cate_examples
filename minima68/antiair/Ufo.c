...
void DrawUfos()
{
	static const byte[] CharsO30 = {
		// O30
		Char_UfoOS00, Char_UfoOS01, Char_Space, Char_UfoO3S3, 
	};
	static const byte[] CharsO74 = {
		// O74
		Char_UfoOS40, Char_UfoOS41, Char_Space, Char_UfoO7S3, 
	};
	static const byte[] CharsOS0 = {
		// OS0
		Char_UfoOS00, Char_UfoOS01, Char_Space, Char_Space, 
	};
	static const byte[] CharsOS4 = {
		// OS4
		Char_UfoOS40, Char_UfoOS41, Char_Space, Char_Space, 
	};
	static const byte[] CharsO03 = {
		// O01
		Char_UfoO010, Char_UfoO011, Char_UfoO012, Char_UfoO013, 
		// O12
		Char_UfoO120, Char_UfoO121, Char_UfoO122, Char_UfoO123, 
		// O23
		Char_UfoO230, Char_UfoO231, Char_UfoO232, Char_UfoO233, 
	};
	static const byte[] CharsO3S = {
		// O3S
		Char_Space, Char_Space, Char_Space, Char_UfoO3S3, 
	};
	static const byte[] CharsO7S = {
		// O7S
		Char_Space, Char_Space, Char_Space, Char_UfoO7S3, 
	};
	static const byte[] CharsA47 = {
		// A45
		Char_UfoA450, Char_UfoA451, Char_UfoA452, Char_UfoA453, 
		// A56
		Char_UfoA560, Char_UfoA561, Char_UfoA562, Char_UfoA563, 
		// A67
		Char_UfoO670, Char_UfoA671, Char_UfoA672, Char_UfoA673, 
	};
	static const byte[] CharsB47 = {
		// B45
		Char_UfoB450, Char_UfoB451, Char_UfoB452, Char_UfoB453, 
		// B56
		Char_UfoB560, Char_UfoB561, Char_UfoB562, Char_UfoB563, 
		// B67
		Char_UfoO670, Char_UfoO671, Char_UfoB672, Char_UfoB673, 
	};
	static const byte[] CharsC47 = {
		// C45
		Char_UfoC450, Char_UfoC451, Char_UfoC452, Char_UfoC453, 
		// C56
		Char_UfoC560, Char_UfoC561, Char_UfoC562, Char_UfoC563, 
		// C67
		Char_UfoO670, Char_UfoO671, Char_UfoO672, Char_UfoC673, 
	};
	static const byte[] CharsO47 = {
		// O45
		Char_Space, Char_UfoO451, Char_UfoO452, Char_UfoO453, 
		// O56
		Char_Space, Char_Space, Char_Space, Char_Space, 
		// O67
		Char_UfoO670, Char_UfoO671, Char_UfoO672, Char_UfoO673, 
	};
    ...
    leftCoord = 
        ...
        + LeftSpace;
    ptr<byte> pVram = pNextPage + VramRowSize * Top + (word)leftCoord;
    for (pRow : UfoRows) {
        byte n;
        n = pRow->memberCount;
        if (n != 0) {
            ...
            repeat (ColumnCount) {
                ...
                if (x >= LeftSpace) {
                    ...
                    if (type != 0) {
                        ...
                        ++pUpper; ++pLower;
                        ptr<byte> pc = CharsO03 + UfoRowCenterXd;
                        repeat (3) {
                            *pUpper = *pc; ++pUpper;
                                _deb();
                            pc += CoordRate;
