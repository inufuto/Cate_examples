...
void DrawEnemyRows()
{
    static const byte[] Chars = {
		...
		// shift2
		Char_AS02, Char_AS22, Char_A1S2, Char_A3S2, Char_A102, Char_A322, Char_A012, Char_A232, 
		Char_BS02, Char_BS22, Char_B1S2, Char_B3S2, Char_B102, Char_B322, Char_B012, Char_B232, 
		Char_CS02, Char_CS22, Char_C1S2, Char_Space, Char_C102, Char_CS22, Char_C012, Char_C232, 
		// shift3
		...
		Char_CS03, Char_Space, Char_C1S3, Char_C3S3, Char_C103, Char_C3S3, Char_C013, Char_C233, 
    };
    ...
    ptr<byte> pVram = pNextPage + VramOffset(leftCoord, Top);
    ptr<EnemyRow> pRow;
    for (pRow : EnemyRows) {
        byte n;
        n = pRow->memberCount;
