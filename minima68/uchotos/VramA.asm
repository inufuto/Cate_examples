...
cseg
PaletteValues:
defb	$00, $00, $00, $00, $9c, $ff, $ff, $00
defb	$00, $ff, $9c, $5a, $00, $ff, $00, $00
defb	$de, $de, $ff, $ff, $00, $ff, $ff, $ff
defb	$00, $00, $00, $9c, $5a, $00, $ff, $bd
defb	$5a, $bd, $5a, $5a, $bd, $7b, $00, $00
defb	$5a, $bd, $ff, $de, $9c, $bd, $bd, $bd
...
VramPtr_: public VramPtr_
    psha | pshb
        ...
        aslb | rola ;*32
        addb @Temp@Byte
        addb #low VramTop | adca #high VramTop
        staa @Temp@Word
        stab @Temp@Word+1
        ldx @Temp@Word
    pula | pulb
