...
constexpr byte Char_Panel = 0x50;
constexpr byte Char_Arrow = 0x55;
constexpr byte Char_ArrowH = 0x55;
constexpr byte Char_ArrowV = 0x59;
constexpr byte Char_Star = 0x5D;
constexpr byte Char_Color = 0x61;
constexpr byte Char_Remain = 0x61;
