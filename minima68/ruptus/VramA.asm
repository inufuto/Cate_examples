...
defb	$00, $ff, $00, $9f, $00, $ff, $00, $3f
defb	$df, $ff, $ff, $ff, $00, $ff, $ff, $ff
defb	$00, $00, $00, $df, $bf, $7f, $df, $00
defb	$3f, $bf, $7f, $5f, $bf, $df, $bf, $00
...
ClearPage_: public ClearPage_
    psha | pshb
        ...
        do
            ...
            while ne | wend
            stx pVram
            ldaa pVram | ldab pVram+1
            addb #VramRowSize-WindowWidth | adca #0
