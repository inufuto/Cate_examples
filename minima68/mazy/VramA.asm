...
defb	$00, $ff, $9f, $df, $00, $ff, $00, $bf
defb	$ff, $ff, $ff, $ff, $00, $ff, $ff, $ff
defb	$00, $00, $00, $7f, $7f, $7f, $9f, $5f
defb	$3f, $df, $7f, $7f, $00, $7f, $00, $00
defb	$5f, $9f, $df, $bf, $9f, $bf, $bf, $bf
        ...
        do
            pshb
                ...
                do
                    ...
                    decb
                while ne | wend
                ldaa pVram+1 | adda #VramRowSize-VVramWidth | staa pVram+1
