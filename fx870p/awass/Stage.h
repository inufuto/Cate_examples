...
extern void DrawFloor(ptr<byte> pVVram, ptr<byte> pMap);
extern void DrawFloorShift(ptr<byte> pVVram, ptr<byte> pMap);
...
extern byte TreatColumn(byte column);
