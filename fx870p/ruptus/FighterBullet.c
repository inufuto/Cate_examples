...
static const byte[] Chars = {
	0x30, 0xc0, 0x00, 0x00, 0xf0, 0x00, 0x00, 0x00,
	0x50, 0x00, 0xa0, 0x00, 0xf0, 0x00, 0x00, 0x00,
};
...
static void Locate(ptr<FighterBullet> pBullet)
{
    ...
    ShowSprite(pBullet->sprite, x, y, Chars + pBullet->code);
    return;
end:
