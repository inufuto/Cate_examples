...
{
    const byte[] Chars = {
        0x30, 0xc0, 0xf0, 0xf0, 0x50, 0xf0, 0x20, 0xc0,
        0xf0, 0x50, 0xf0, 0xa0, 0x10, 0xc0, 0xa0, 0xf0,
        0xf0, 0xf0, 0x30, 0xc0, 0x30, 0x40, 0xf0, 0xa0,
        0x50, 0xf0, 0xa0, 0xf0, 0xf0, 0x50, 0x30, 0x80,
    };
    byte x, y;
    x = OffsetX(pEnemy->x);
    ...
    if (x < VVramWidth - HalfSize * 2 && y < VVramHeight - HalfSize * 2) {
        ShowSprite(pEnemy->sprite, x, y, Chars + (pEnemy->direction << 2));
    }
    else {
