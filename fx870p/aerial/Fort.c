...
constexpr byte FireMask = 7;//(1 << 2) - 1;
...
{
    const byte[] Chars = {
        0x10, 0xe0, 0xa0, 0xa0, 0xb0, 0x60, 0xf0, 0xf0,
	    0xf0, 0xf0, 0xf0, 0xf0, 0x20, 0xd0, 0x50, 0x50,
	    0x70, 0x90, 0x00, 0x20, 0x90, 0xe0, 0x80, 0x00,
    };
    ptr<Fort> pFort;
    for (pFort: Forts) {
        byte w, added;
