...
constexpr byte Char_Fighter_Left = 3 * 4;
constexpr byte Char_Fighter_Right = 4 * 4;

static const Type[] types = {
    { RangeX, -1, 0, Char_Fighter_Left, 10 },
    { 0, 1, 1, Char_Fighter_Right, 15 },
};
