...
ext MonoPattern, ColorPattern, SpritePattern, ColorPatternV2
ext VVram_

SpritePatternSize equ CharHeight*2*4*4
Offscreen equ Vram+16000
Char_EndV2 equ Char_Sprite+4
...
InitOffscreen:
    ld hl,Offscreen
    ld de,PatternRam+PatternSize*Char_Fence
    exx
        ld bc,CharHeight*(Char_Sprite-Char_Fence)
    exx
    do
        ld bc,35ch
        do
