...
ext MonoPattern, SpritePattern, ColorPatternV2
ext VVram_

SpritePatternSize equ CharHeight*2*4*4
Offscreen equ Vram+16000
Char_EndV2 equ Char_Sprite+4*2
...
InitVram: public InitVram
    ...
    ld de,ColorPatternV2
    ld bc,CharHeight*PlaneCount*(Char_EndV2-Char_Sprite)
    call MakePatternColor
...
InitOffscreen:
    ld hl,Offscreen
    ld de,PatternRam+PatternSize*Char_Ladder
    exx
        ld bc,CharHeight*(Char_Sprite-Char_Ladder)
    exx
    do
        ld bc,35ch
        do
...
EndDraw_: public EndDraw_
    push af | push hl | push de | push bc
        ...
        ld hl,Backup
        exx
            ld hl,Vram+VramRowSize*StageTopY
        exx
        ld c, VVramHeight
        do
            ld b,VVramWidth
