...
InitSoundV1: public InitSoundV1
    push hl
        ld hl,0
        ld (SoundProc),hl
    pop hl
...
CallSoundV1: public CallSoundV1
    push af | push hl
    ld hl,(SoundProc)
    ld a,l
    or h
...
; use af
    ...
    pop bc
ret 
Sound_BeepV1: public Sound_BeepV1
    push af
    push bc
        ld bc,750
        call Beep
...
loose_notes:
    defb 1,C4, 0
Sound_LooseV1: public Sound_LooseV1
    push hl
        ld hl,loose_notes
        call Melody
    pop hl
...
Sound_Hit:
    ...
    pop hl
ret
Sound_HitV1: public Sound_HitV1
    push hl
        ld hl,Sound_Hit
        ld (SoundProc),hl
    pop hl
...
Sound_Stole:
    ...
    pop hl
ret
Sound_StoleV1: public Sound_StoleV1
    push hl
        ld hl,Sound_Stole
        ld (SoundProc),hl
    pop hl
...
Sound_FireV1: public Sound_FireV1
    push hl
        ld hl,Sound_BeepV1
        ld (SoundProc),hl
    pop hl
...
Sound_BonusV1: public Sound_BonusV1
    push hl
        ld hl,bonus_notes
        call Melody
    pop hl
...
start_notes: 
	...
	defb 12,0
    defb 0
Sound_StartV1: public Sound_StartV1
    push hl
        ld hl,start_notes
        call Melody
    pop hl
...
clear_notes: 
	...
	defb 24,0
    defb 0
Sound_ClearV1: public Sound_ClearV1
    push hl
        ld hl,clear_notes
        call Melody
    pop hl
...
over_notes: 
	...
	defb 12,0
    defb 0
Sound_GameOverV1: public Sound_GameOverV1
    push hl
        ld hl,over_notes
        call Melody
    pop hl
