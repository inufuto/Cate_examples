...
BGM_B:
    ...
    defb $ff
BGM_C:
	defb 18,0, 17,F2,1,0, 17,F2,1,0
	defb 11,F2,1,0, 17,C3,1,0, 17,C3,1,0
	defb 11,C3,1,0, 23,F2,1,0, 23,G2,1,0
	defb 35,A2,1,0, 18,0
	defb 17,A2,1,0, 17,A2,1,0, 11,A2,1,0
	defb 17,G2,1,0, 17,G2,1,0, 11,G2,1,0
	defb 23,F2,1,0, 23,C3,1,0
	defb 35,F2,1,0
    defb $ff
