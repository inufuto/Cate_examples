...
{
    {
        word vram = PrintNumber5(Vram + VramRowSize * VramStep, Score);
        PrintC(vram, '0');
    }
    {
...
void Title()
{
    ...
    PrintS(Vram + VramRowSize * 19 + (VramWidth - 14) * VramStep / 2, "PUSH ENTER KEY");
    PrintS(Vram + VramRowSize * 20 + (VramWidth - 14) * VramStep / 2, "OR SHIFT KEY");
