...
constexpr byte Pattern_Begin0 = 0;
...
constexpr byte Pattern_End0 = 16;

constexpr byte Pattern_Begin1 = 32;
constexpr byte Pattern_FireBullet = 32;
constexpr byte Pattern_Fire = 33;
constexpr byte Pattern_Point = 34;
constexpr byte Pattern_End1 = 38;
