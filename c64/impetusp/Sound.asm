...
MaxVol equ $1f
HighNoiseValue equ 4000
LowNoiseValue equ HighNoiseValue / 2
...
InitSound: public InitSound
    ...
    ldy #0
    do
        lda #$00 | sta $D405,y ; Attack and Decay length
        lda #$f0 | sta $D406,y ; Sustain volume and Release length
        tya | clc|adc #7 | tay
        cpy #count*7
    while ne | wend
            ...
            do
                ...
                if ne
                    ...
                    if eq
                        ...
                        if eq
                            ldy <ZB0
                            lda #low HighNoiseValue
                            sta $D400,y
                            lda #high HighNoiseValue
                            sta $D401,y
                            lda #MaxVol
                            sta Channel_Vol,x
                            lda #$81
                        ...
                        if eq
                            ldy <ZB0
                            lda #low LowNoiseValue
                            sta $D400,y
                            lda #high LowNoiseValue
                            sta $D401,y
                            lda #$7b
                            sta $D406,y
                            lda #MaxVol
...
MelodyPrior:
    sei
        ...
        sty Channels+unitSize*1+Channel_Ptr+1
        pha
            lda #0
            sta $D404+7
            lda #1
...
MelodyWait:
    pha
        sei
            ...
            sty Channels+unitSize*2+Channel_Ptr+1
            lda #1
            sta Channels+unitSize*2+Channel_Len
        cli
        do
            lda Channels+unitSize*2+Channel_Ptr
            ora Channels+unitSize*2+Channel_Ptr+1
        while ne | wend
    pla
rts
...
BGM_B:
	...
	defb 23,C5,1,0
	defb 11,C5,1,0, 11,B4,1,0
	defb 11,C5,1,0, 17,G5,1,0
	defb 17,D5,1,0, 35,D5,1,0
	defb 24,0
	defb 17,F5,1,0, 17,E5,1,0
	defb 23,F5,1,0
	defb 11,F5,1,0, 11,E5,1,0
	defb 11,F5,1,0, 17,E5,1,0
	defb 17,C5,1,0, 35,C5,1,0
	defb 24,0
	defb 5,A4,1,0, 5,A4,1,0, 5,B4,1,0, 11,C5,1,0
	defb 11,C5,1,0, 5,C5,1,0, 5,B4,1,0
	defb 5,B4,1,0, 5,C5,1,0, 11,D5,1,0
	defb 11,D5,1,0, 5,D5,1,0, 5,C5,1,0
	defb 5,C5,1,0, 5,D5,1,0, 11,E5,1,0
	defb 11,E5,1,0, 5,E5,1,0, 5,F5,1,0
	defb 11,F5,1,0, 17,E5,1,0
	defb 12,0
    defb $ff
BGM_C:
	defb 11,A2,1,0, 6,0, 5,A2,1,0
	defb 6,0, 5,A2,1,0, 6,0, 5,A2,1,0
	defb 11,D3,1,0, 6,0, 5,D3,1,0
	defb 6,0, 5,D3,1,0, 6,0, 5,D3,1,0
	defb 11,E2,1,0, 6,0, 5,E2,1,0
	defb 6,0, 5,E2,1,0, 6,0, 5,E2,1,0
	defb 11,A2,1,0, 6,0, 5,A2,1,0
	defb 6,0, 5,A2,1,0, 6,0, 5,A2,1,0
	defb 11,A2,1,0, 6,0, 5,A2,1,0
	defb 6,0, 5,A2,1,0, 6,0, 5,A2,1,0
	defb 11,F2,1,0, 6,0, 5,F2,1,0
	defb 6,0, 5,F2,1,0, 6,0, 5,F2,1,0
	defb 11,G2,1,0, 6,0, 5,G2,1,0
	defb 6,0, 5,G2,1,0, 6,0, 5,G2,1,0
	defb 11,E2,1,0, 6,0, 5,E2,1,0
	defb 6,0, 5,E2,1,0, 6,0, 5,E2,1,0
	defb 11,D3,1,0, 6,0, 5,D3,1,0
	defb 6,0, 5,D3,1,0, 6,0, 5,D3,1,0
	defb 11,G2,1,0, 6,0, 5,G2,1,0
	defb 6,0, 5,G2,1,0, 6,0, 5,G2,1,0
	defb 11,C3,1,0, 6,0, 5,C3,1,0
	defb 6,0, 5,C3,1,0, 6,0, 5,C3,1,0
	defb 11,C3,1,0, 6,0, 5,C3,1,0
	defb 6,0, 5,C3,1,0, 6,0, 5,C3,1,0
	defb 5,A2,1,0, 5,A2,1,0, 6,0, 5,A2,1,0
	defb 6,0, 5,A2,1,0, 6,0, 5,A2,1,0
	defb 5,D3,1,0, 5,D3,1,0, 6,0, 5,D3,1,0
	defb 6,0, 5,D3,1,0, 6,0, 5,D3,1,0
	defb 5,A2,1,0, 5,A2,1,0, 6,0, 5,A2,1,0
	defb 6,0, 5,A2,1,0, 6,0, 5,A2,1,0
	defb 5,F2,1,0, 5,F2,1,0, 6,0, 17,E2,1,0
	defb 12,0
    defb $ff
