...
cseg
PaletteTable:
defb	00h, 00h, 0fh, 00h, 00h, 0fh, 9dh, 0dh
defb	0f0h, 00h, 0ffh, 00h, 0d3h, 0fh, 0ffh, 0fh
defb	00h, 00h, 77h, 07h, 53h, 09h, 55h, 0bh
defb	70h, 00h, 59h, 00h, 0d3h, 0fh, 0bbh, 0bh
ColorTable:
defb 16, 5 ; Logo
defb 8, 7 ; Line_Normal
defb 8, 2 ; Line_Red
defb 4, 13 ; Block
defb 4, 14 ; Item
defb 0
...
EndDraw_: public EndDraw_
	push ax | push cx | push dx | push bx | push si | push di
        ...
        mov bx,SpriteLayer+VVramWidth*0
		mov si,Backup
