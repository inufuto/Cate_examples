...
cseg
PaletteTable:
defb	00h, 00h, 3dh, 05h, 00h, 0fh, 9dh, 0dh
defb	0f0h, 00h, 9dh, 09h, 0f0h, 0fh, 0ffh, 0fh
defb	00h, 00h, 77h, 07h, 53h, 09h, 55h, 0bh
defb	0d7h, 0fh, 59h, 00h, 0b0h, 0fh, 0bbh, 0bh
ColorTable:
defb 16, 12 ; Logo
defb 10, 12 ; Soil
defb 1, 15 ; Bedrock
...
InitVram: public InitVram
    ...
    mov cx,Pattern_End*SpriteHeight
    do
        push cx
            mov ch,2
            do
...
EndDraw_: public EndDraw_
	push ax | push cx | push dx | push bx | push si | push di
        ...
        mov bx,SpriteLayer+VVramWidth*2*0
		mov si,Backup
