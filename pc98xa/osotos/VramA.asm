...
cseg
PaletteTable:
defb	00h, 00h, 0fh, 05h, 00h, 0fh, 0bfh, 0fh
defb	0f0h, 00h, 0ffh, 00h, 0f0h, 0fh, 0ffh, 0fh
defb	00h, 00h, 44h, 08h, 0b5h, 0fh, 55h, 0bh
defb	50h, 00h, 5bh, 00h, 0f5h, 0fh, 0bbh, 0bh
ColorTable:
defb 16, 10 ; Logo
defb 1, 9 ; Floor
defb 2, 10 ; Ladder
...
EndDraw_: public EndDraw_
	push ax | push cx | push dx | push bx | push si | push di
        ...
        mov bx,SpriteLayer+VVramWidth*2*2
		mov si,Backup
		mov di,(Vram+VramRowSize*1)*2
		mov ch,VVramHeight-3
		do
			mov cl,VVramWidth
			do 
