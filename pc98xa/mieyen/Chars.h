...
constexpr word Char_Wall = 0x10;
constexpr word Char_Dot = 0x20;
constexpr word Char_Color = 0x24;
constexpr word Char_SmallFood = 0x24;
constexpr word Char_Remain = 0x25;
constexpr word Char_Food = 0x26;
constexpr word Char_End = 0x2A;
