...
constexpr word Char_MovablePanel = 0x10;
constexpr word Char_Arrow = 0x18;
constexpr word Char_ArrowH = 0x18;
constexpr word Char_ArrowV = 0x1C;
constexpr word Char_Star = 0x20;
constexpr word Char_Color = 0x24;
constexpr word Char_Remain = 0x24;
constexpr word Char_End = 0x25;
