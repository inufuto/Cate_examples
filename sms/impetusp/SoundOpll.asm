...
cseg
InstTable:
    defb Inst_Effect, Inst_Melody, Inst_Bass
...
Melody:
    di
        ld (ChannelsOpll+unitSize+Channel_Ptr),hl
        ld a,1
        ld (ChannelsOpll+unitSize+Channel_Len),a

        ld a,Opll_Volume+1
        out (Port_Opll),a
        rst 30h
        ld a,(ChannelsOpll+unitSize+Channel_Inst)
        out (Port_Opll+1),a
        rst 30h
    ei
ret
...
MelodyWait:
    call Melody
    do
        ld hl,(ChannelsOpll+unitSize+Channel_Ptr)
        ld a,l | or h
    while nz | wend
ret 
