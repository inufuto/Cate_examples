...
beep_notes:
    defb 1,A4, 0
Sound_BeepOpll: public Sound_BeepOpll
    push hl
        ld hl,beep_notes
        call MelodyWait
    pop hl
...
Sound_GetOpll: public Sound_GetOpll
    push hl
        ld hl,beep_notes
        call Melody
    pop hl
...
over_notes: 
    over_notes: defb N8,C5, N8,G4, N8,E4, N8,C5,  N8,B4, N8,G4, N8,E4, N8,B4,  N4,A4, N4,B4,  N2,C5
    defb 0
Sound_GameOverOpll: 
