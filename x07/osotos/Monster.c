...
static void Show(ptr<Movable> pMonster)
{
    static const byte[] Chars = {
        0xd0, 0xd0, 0xd0, 0xb0, 0xe0, 0xe0, 0x70, 0xe0,
	    0xf0, 0xf0, 0xd0, 0xe0, 0xd0, 0xd0, 0xd0, 0xe0,
	    0xd0, 0xd0, 0xc0, 0xc0, 0xe0, 0xe0, 0xc0, 0xc0,
	    0xf0, 0xf0, 0xc0, 0xc0, 0xd0, 0xd0, 0xc0, 0xc0,
    };
    byte status = pMonster->status;
    byte index = status & PatternMask;
    byte pattern;
    ...
    ShowSprite(pMonster, Chars + pattern);
}
