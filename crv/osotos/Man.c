...
static const Direction[] Directions = {
    { Keys_Left, -1, 0, Pattern_Man_Left, Pattern_Man_Left_Push },
    { Keys_Right, 1, 0, Pattern_Man_Right, Pattern_Man_Right_Push },
    { Keys_Up, 0, -1, Pattern_Man_UpDown, 0 },
    { Keys_Down, 0, 1, Pattern_Man_UpDown, Pattern_Man_Down_Push },
};
...
void LooseMan()
{
    ...
    i = 0;
    do {
        ShowSprite(&Man, patterns[i & 3], Color);
        UpdateSprites();
        Sound_Loose();
        ++i;
    } while (i < 8);
