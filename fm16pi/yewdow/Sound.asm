...
start_notes:
	...
	defb 11,D4,1,0, 11,D4,1,0
	defb 7,B4,1,0, 3,A4,1,0, 7,B4,1,0, 15,A4,1,0
	defb 11,A4,1,0, 35,G4,1,0
	defb 12,0
    defb 0
...
clear_notes:
	...
	defb 19,D4,1,0, 11,E4,1,0
	defb 3,E4,1,0, 7,D4,1,0, 3,C4,1,0, 7,D4,1,0
	defb 3,D4,1,0, 7,E4,1,0, 3,F4S,1,0, 35,G4,1,0
	defb 12,0
    defb 0
...
; void Sound_GameOver();
over_notes:
	defb 7,G4,1,0, 3,G4,1,0, 7,F4S,1,0, 3,F4S,1,0
	defb 7,E4,1,0, 3,E4,1,0, 7,D4,1,0, 3,B3,1,0
	defb 7,D4,1,0, 3,D4,1,0, 7,E4,1,0, 3,F4S,1,0
	defb 23,G4,1,0
    defb 0
...
BGM_B:
	defb 11,G4,1,0, 11,G4,1,0
	defb 11,D4,1,0, 11,D4,1,0
	defb 7,B4,1,0, 3,A4,1,0, 7,B4,1,0, 23,A4,1,0
	defb 4,0, 11,B4,1,0, 11,D5,1,0
	defb 7,A4,1,0, 3,G4,1,0, 7,A4,1,0, 47,B4,1,0
	defb 4,0, 11,C5,1,0, 11,C5,1,0
	defb 11,B4,1,0, 11,B4,1,0
	defb 7,A4,1,0, 3,A4,1,0, 7,A4,1,0, 23,B4,1,0
	defb 4,0, 11,C5,1,0, 11,C5,1,0
	defb 11,B4,1,0, 11,B4,1,0
	defb 7,D5,1,0, 3,D5,1,0, 7,D5,1,0, 23,A4,1,0
	defb 4,0, 11,G4,1,0, 11,G4,1,0
	defb 11,D4,1,0, 11,D4,1,0
	defb 7,B4,1,0, 3,A4,1,0, 7,B4,1,0, 23,A4,1,0
	defb 4,0, 11,B4,1,0, 11,D5,1,0
	defb 7,A4,1,0, 3,G4,1,0, 7,A4,1,0, 47,B4,1,0
	defb 4,0, 11,C5,1,0, 11,C5,1,0
	defb 11,B4,1,0, 11,B4,1,0
	defb 7,D5,1,0, 3,D5,1,0, 7,D5,1,0, 15,B4,1,0
	defb 11,A4,1,0, 11,G4,1,0
	defb 11,D4,1,0, 7,G4,1,0, 11,A4,1,0
	defb 47,G4,1,0
	defb 4,0
    defb 0ffh
