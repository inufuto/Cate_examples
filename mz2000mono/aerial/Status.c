...
void PrintScore()
{
    ...
    vram = PrintNumber5(Vram + VramRowSize * 2 + VramStep * 34, Score);
    PrintC(vram, '0');
...
void Title()
{
    ...
    PrintS(Vram + VramRowSize * 20 + VramStep * 9, "OR TAB KEY");
    PrintS(Vram + VramRowSize * 23 + 27 * VramStep, "INUFUTO 2024");
}
