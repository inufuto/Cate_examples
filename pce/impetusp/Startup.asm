...
TimerCount: 
    defb 0
DisplayPage: public DisplayPage
    defb 0
...
Startup: public Startup
    ...
    defb $03,5 ; st0 Control
    defb $13,$c8 ; st1
    defb $23,0 ; st2

    defb $03,9 ; st0 Memory Access Width
    defb $13,$40 ; st1 32*64
    defb $23,0 ; st2

    defb $03,7 ; st0 BGX Scroll
    defb $13,0 ; st1
    defb $23,0 ; st2

    defb $03,8 ; st0 BGY Scroll
    defb $13,248 ; st1
    defb $23,0 ; st2
