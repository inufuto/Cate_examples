...
const Tile[] Tiles = {
	...
	{ // 1
		{ // chars
			...
			Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, 
			Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, 
			Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 16, 
		},
	},
	{ // 2
		{ // chars
			...
			Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, 
			Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, 
			Char_Terrain + 13, Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, 
		},
	},
	{ // 3
		{ // chars
			...
			Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, 
			Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, 
			Char_Terrain + 13, Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 16, 
		},
	},
	{ // 4
		{ // chars
			Char_Terrain + 16, Char_Terrain + 10, Char_Terrain + 10, Char_Terrain + 13, 
			Char_Terrain + 0, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 8, 
			Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, 
			Char_Terrain + 2, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 4, 
		},
	},
	{ // 5
		{ // chars
			Char_Terrain + 16, Char_Terrain + 10, Char_Terrain + 10, Char_Terrain + 10, 
			Char_Terrain + 0, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, 
			Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, 
	...
	{ // 7
		{ // chars
			Char_Terrain + 10, Char_Terrain + 10, Char_Terrain + 10, Char_Terrain + 13, 
	...
	{ // 12
		{ // chars
			Char_Terrain + 10, Char_Terrain + 10, Char_Terrain + 10, Char_Terrain + 0, 
			Char_Terrain + 1, Char_Terrain + 27, Char_Terrain + 27, Char_Terrain + 27, 
			Char_Terrain + 1, Char_Terrain + 25, Char_Terrain + 25, Char_Terrain + 25, 
			Char_Terrain + 1, Char_Terrain + 25, Char_Terrain + 25, Char_Terrain + 26, 
		},
	},
	{ // 13
		{ // chars
	...
	{ // 15
		{ // chars
			...
			Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, 
			Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, 
			Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 21, 
		},
	},
	{ // 16
		{ // chars
			...
			Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, 
			Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, 
			Char_Terrain + 24, Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, 
		},
	},
	{ // 17
		{ // chars
			...
			Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, 
			Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, 
			Char_Terrain + 24, Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 21, 
		},
	},
	{ // 18
		{ // chars
			...
			Char_Terrain + 23, Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 23, 
		},
	},
	{ // 19
		{ // chars
			Char_Terrain + 21, Char_Terrain + 7, Char_Terrain + 7, Char_Terrain + 24, 
			Char_Terrain + 9, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 6, 
			Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, 
			Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, 
		},
	},
	{ // 20
		{ // chars
			Char_Terrain + 21, Char_Terrain + 7, Char_Terrain + 7, Char_Terrain + 7, 
			Char_Terrain + 9, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, 
			Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, 
			Char_Terrain + 5, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, 
		},
	},
	{ // 21
		{ // chars
	...
	{ // 22
		{ // chars
			Char_Terrain + 21, Char_Terrain + 7, Char_Terrain + 7, Char_Terrain + 9, 
			Char_Terrain + 9, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, 
			Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, 
			Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, 
		},
	...
	{ // 23
		{ // chars
			...
			Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 6, 
			Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, 
	...
	{ // 26
		{ // chars
			Char_Terrain + 7, Char_Terrain + 7, Char_Terrain + 7, Char_Terrain + 9, 
			Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, 
			Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, 
			Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, 
		},
	...
	{ // 27
		{ // chars
			...
			Char_Terrain + 1, Char_Terrain + 25, Char_Terrain + 25, Char_Terrain + 1, 
			Char_Terrain + 1, Char_Terrain + 25, Char_Terrain + 25, Char_Terrain + 1, 
			Char_Terrain + 1, Char_Terrain + 25, Char_Terrain + 25, Char_Terrain + 1, 
		},
	},
	{ // 28
		{ // chars
			Char_Terrain + 6, Char_Terrain + 7, Char_Terrain + 7, Char_Terrain + 24, 
			Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 6, 
			Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, 
			Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 3, 
		},
	...
	{ // 31
		{ // chars
			Char_Terrain + 6, Char_Terrain + 7, Char_Terrain + 7, Char_Terrain + 9, 
			Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, 
			Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, 
			Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, 
		},
	...
	{ // 32
		{ // chars
			Char_Terrain + 8, Char_Terrain + 10, Char_Terrain + 10, Char_Terrain + 13, 
			Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 8, 
			Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, 
			Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, 
		},
	...
	{ // 36
		{ // chars
			Char_Terrain + 8, Char_Terrain + 10, Char_Terrain + 10, Char_Terrain + 0, 
			Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, 
			Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, 
			Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, 
		},
	...
	{ // 37
		{ // chars
			Char_Terrain + 18, Char_Terrain + 20, Char_Terrain + 20, Char_Terrain + 20, 
			Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, 
			Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, 
			Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, 
		},
	...
	{ // 38
		{ // chars
			Char_Terrain + 18, Char_Terrain + 20, Char_Terrain + 20, Char_Terrain + 5, 
	...
	{ // 43
		{ // chars
			Char_Terrain + 20, Char_Terrain + 20, Char_Terrain + 20, Char_Terrain + 19, 
			Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, 
			Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, 
			Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, 
		},
	...
	{ // 45
		{ // chars
			Char_Terrain + 20, Char_Terrain + 20, Char_Terrain + 20, Char_Terrain + 5, 
			Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 18, 
			Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, 
			Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, 
		},
	...
	{ // 46
		{ // chars
			Char_Terrain + 20, Char_Terrain + 25, Char_Terrain + 25, Char_Terrain + 20, 
			Char_Terrain + 17, Char_Terrain + 23, Char_Terrain + 23, Char_Terrain + 17, 
			Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, 
			Char_Terrain + 17, Char_Terrain + 22, Char_Terrain + 22, Char_Terrain + 17, 
		},
	},
	{ // 47
		{ // chars
			Char_Terrain + 4, Char_Terrain + 14, Char_Terrain + 14, Char_Terrain + 12, 
	...
	{ // 48
		{ // chars
			Char_Terrain + 4, Char_Terrain + 14, Char_Terrain + 14, Char_Terrain + 14, 
			Char_Terrain + 12, Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, 
			Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, 
			Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, 
		},
	...
	{ // 49
		{ // chars
			Char_Terrain + 4, Char_Terrain + 14, Char_Terrain + 14, Char_Terrain + 2, 
			Char_Terrain + 12, Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 15, 
			Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, 
			Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, 
		},
	},
	{ // 50
		{ // chars
			Char_Terrain + 3, Char_Terrain + 20, Char_Terrain + 20, Char_Terrain + 19, 
			Char_Terrain + 19, Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, 
			Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, 
			Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, 
		},
	},
	...
	{ // 52
		{ // chars
			Char_Terrain + 3, Char_Terrain + 20, Char_Terrain + 20, Char_Terrain + 20, 
			Char_Terrain + 19, Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, 
			Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, 
			Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, Char_Terrain + 17, 
		},
	...
	{ // 59
		{ // chars
			Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, 
			Char_Terrain + 1, Char_Terrain + 29, Char_Terrain + 29, Char_Terrain + 29, 
			Char_Terrain + 1, Char_Terrain + 28, Char_Terrain + 28, Char_Terrain + 28, 
			Char_Terrain + 1, Char_Terrain + 28, Char_Terrain + 28, Char_Terrain + 28, 
		},
	},
	{ // 60
		{ // chars
			Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, Char_Terrain + 1, 
			Char_Terrain + 27, Char_Terrain + 27, Char_Terrain + 27, Char_Terrain + 1, 
			Char_Terrain + 25, Char_Terrain + 25, Char_Terrain + 25, Char_Terrain + 1, 
			Char_Terrain + 26, Char_Terrain + 25, Char_Terrain + 25, Char_Terrain + 1, 
		},
	},
	{ // 61
		{ // chars
	...
	{ // 63
		{ // chars
			...
			Char_Terrain + 28, Char_Terrain + 28, Char_Terrain + 28, Char_Terrain + 1, 
			Char_Terrain + 28, Char_Terrain + 28, Char_Terrain + 28, Char_Terrain + 1, 
		},
	},
	{ // 64
	...
	{ // 66
		{ // chars
			Char_Terrain + 1, Char_Terrain + 25, Char_Terrain + 25, Char_Terrain + 1, 
			Char_Terrain + 1, Char_Terrain + 25, Char_Terrain + 25, Char_Terrain + 27, 
			Char_Terrain + 1, Char_Terrain + 25, Char_Terrain + 25, Char_Terrain + 25, 
			Char_Terrain + 1, Char_Terrain + 26, Char_Terrain + 26, Char_Terrain + 26, 
		},
	},
	{ // 67
		{ // chars
	...
	{ // 68
		{ // chars
			Char_Terrain + 1, Char_Terrain + 25, Char_Terrain + 25, Char_Terrain + 1, 
			Char_Terrain + 27, Char_Terrain + 25, Char_Terrain + 25, Char_Terrain + 1, 
			Char_Terrain + 25, Char_Terrain + 25, Char_Terrain + 25, Char_Terrain + 1, 
			Char_Terrain + 26, Char_Terrain + 26, Char_Terrain + 26, Char_Terrain + 1, 
		},
	},
	{ // 69
		{ // chars
	...
	{ // 71
		{ // chars
			...
			Char_Terrain + 1, Char_Terrain + 28, Char_Terrain + 28, Char_Terrain + 28, 
			Char_Terrain + 1, Char_Terrain + 28, Char_Terrain + 28, Char_Terrain + 28, 
			Char_Terrain + 1, Char_Terrain + 30, Char_Terrain + 30, Char_Terrain + 30, 
		},
	},
	{ // 72
		{ // chars
	...
	{ // 73
		{ // chars
			Char_Terrain + 15, Char_Terrain + 14, Char_Terrain + 14, Char_Terrain + 12, 
			Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, 
			Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, 
			Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, 
		},
	...
	{ // 75
		{ // chars
			Char_Terrain + 15, Char_Terrain + 14, Char_Terrain + 14, Char_Terrain + 2, 
			Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 15, 
			Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, 
			Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, Char_Terrain + 11, 
		},
	...
	{ // 77
		{ // chars
			...
			Char_Terrain + 28, Char_Terrain + 28, Char_Terrain + 28, Char_Terrain + 1, 
			Char_Terrain + 28, Char_Terrain + 28, Char_Terrain + 28, Char_Terrain + 1, 
			Char_Terrain + 30, Char_Terrain + 30, Char_Terrain + 30, Char_Terrain + 1, 
		},
	},
	{ // 78
		{ // chars
	...
	{ // 79
		{ // chars
			...
			Char_Terrain + 30, Char_Terrain + 30, Char_Terrain + 30, Char_Terrain + 26, 
		},
	},
	{ // 80
		{ // chars
