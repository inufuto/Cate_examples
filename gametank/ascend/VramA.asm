...
cseg
PaletteValues:
	defb	$00, $9b, $39, $77, $f7, $b7, $1f, $07
	defb	$01, $e5, $34, $5c, $fa, $bb, $4f, $67
ColorTable:
defb 16,14 ; Logo
defb 0
...
PresentBackground_: public PresentBackground_
    pha
        ...
        lda #VramTopY+AsciiHeight*2 | sta BLT_VY
        clc|adc ScrollY_ | sta BLT_GY
        lda #VramWidth-1 | sta BLT_WIDTH
...
cseg
CharTable:
    defb " -0123456789:ACEFGHIMNOPRSTUV"
...
DrawSprite_: public DrawSprite_
    pha
        ...
        sty BLT_VX
        lda DrawSprite_y | clc|adc #VramTopY+AsciiHeight*2 | sta BLT_VY
