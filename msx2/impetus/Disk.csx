...
private static void ReadProgram(string name, ref int trackNumber, ref int sectorIndex)
{
...
ReadLoader();
ReadProgram(name + "1", ref trackNumber, ref sectorIndex);
ReadProgram(name + "2", ref trackNumber, ref sectorIndex);
