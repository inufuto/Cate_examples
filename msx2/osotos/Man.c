...
static const Direction[] Directions = {
    { Keys_Left, -1, 0, Pattern_Man_Left / 2, Pattern_Man_Left_Push / 2 },
    { Keys_Right, 1, 0, Pattern_Man_Right / 2, Pattern_Man_Right_Push / 2 },
    { Keys_Up, 0, -1, Pattern_Man_UpDown / 2, 0 },
    { Keys_Down, 0, 1, Pattern_Man_UpDown / 2, Pattern_Man_Down_Push / 2 },
};
