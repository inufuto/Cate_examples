...
cseg
PaletteValues:
defb	00h, 00h, 17h, 01h, 70h, 00h, 66h, 04h
defb	70h, 04h, 77h, 07h, 70h, 07h, 06h, 06h
defb	07h, 05h, 60h, 00h, 70h, 07h, 33h, 00h
defb	00h, 06h, 11h, 01h, 62h, 03h, 74h, 05h
ColorTable:
defb 64, 05h ; Ascii
defb 16, 07h ; Logo
defb 16, 01h ; Wall
...
DrawSprite_: public DrawSprite_
    push af | push hl | push de | push bc
        add a,a | ld l,a
        ld a,e | add a,a | add a,16 | ld h,a
