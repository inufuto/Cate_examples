...
LcdCmdPort equ 0f1h
LcdParamPort equ 0f0h

Cmd_Mode equ 00h
Cmd_CharPitch equ 01h
Cmd_NumOfChar equ 02h
Cmd_SetAddressL equ 0ah
Cmd_SetAddressH equ 0bh
Cmd_Write equ 0ch
