...
void Title()
{
    ...
    PrintS(Vram + VramRowSize * 17 + 9 * VramStep, "PUSH SLOW KEY");
    PrintS(Vram + VramRowSize * 19 + 9 * VramStep, "OR HTAB KEY");
    PrintS(Vram + VramRowSize * 21 + 20 * VramStep, "INUFUTO 2026");
}
