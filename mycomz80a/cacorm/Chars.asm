...
;	line
	defb	88h, 0f8h, 8fh, 88h, 11h, 0f1h, 1fh, 11h
	defb	0fh, 00h, 00h, 0f0h, 11h, 11h, 88h, 88h
	defb	0cch, 0ffh, 0ffh, 0cch, 33h, 0ffh, 0ffh, 33h
	defb	0ffh, 00h, 00h, 0ffh, 33h, 33h, 0cch, 0cch
;	8dot
