...
constexpr byte Char_Bedrock = 0x12;
constexpr byte Char_Wall = 0x13;
constexpr byte Char_Man = 0x1C;
constexpr byte Char_Ghost = 0x5C;
constexpr byte Char_Chaser = 0x9C;
constexpr byte Char_Rock = 0xA0;
constexpr byte Char_Point = 0xA4;
constexpr byte Char_Loose = 0xB4;
constexpr byte Char_Box = 0xBC;
