...
static const Direction[] Directions = {
    { Keys_Left, -1, 0, (GChar_Man_Left - GChar_Man) / 4, (GChar_Man_Left_Push - GChar_Man) / 4 },
    { Keys_Right, 1, 0, (GChar_Man_Right - GChar_Man) / 4, (GChar_Man_Right_Push - GChar_Man) / 4 },
    { Keys_Up, 0, -1, (GChar_Man_UpDown - GChar_Man) / 4, 0 },
    { Keys_Down, 0, 1, (GChar_Man_UpDown - GChar_Man) / 4, (GChar_Man_Down_Push - GChar_Man) / 4 },
};
...
static void Show()
{
    ...
    ShowSprite(&Man, (pattern << 2) + GChar_Man);
}

void InitMan()
{
    Man.sprite = Sprite_Man;
    Man.status = Movable_Live | ((GChar_Man_Left - GChar_Man) / 4);
    Man.dx = 0;
    Man.dy = 0;
