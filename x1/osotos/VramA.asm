...
ext MonoPattern, ColorPattern, GMonoPattern, GColorPattern
ext VVram_
ext PollVSync_
...
GPatternRam: public GPatternRam
    defs PatternSize*GChar_End
tempPattern:
    defs PatternSize
...
InitVram: public InitVram
    ...
    wend
    ld hl,GColorPattern
    ld de,GPatternRam+PatternSize*GChar_Man
    ld bc,PatternSize*(GChar_End-GChar_Man)
    ldir
ret
