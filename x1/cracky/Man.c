...
constexpr byte Pattern_Left = (GChar_Man_Left - GChar_Man) / 4;
constexpr byte Pattern_Right = (GChar_Man_Right - GChar_Man) / 4;
constexpr byte Pattern_UpDown = (GChar_Man_UpDown - GChar_Man) / 4;
