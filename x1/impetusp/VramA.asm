...
GVramTop equ GVram+VramWidth*0
...
MakeFort:
    ld a,Char_Fort1
    ld de,ColorPattern+PatternSize*(Char_Fort0-Char_Color)
    exx
        ld b,6
    exx
    do
        push af
            ld hl,TempPattern
            ld bc,ColorPattern+PatternSize*(Char_Terrain+25-Char_Color)
            exx
                ld c,PlaneCount
            exx
            do
    ...
    ld bc,ColorPattern+PatternSize*(Char_Fort0-Char_Color)+CharHeight/2
    exx
        ld b,6*5
    exx
    do
    ...
    do
        push af
            ld hl,TempPattern
            ld de,ColorPattern+PatternSize*(Char_Terrain+25-Char_Color)
            exx
                ld c,PlaneCount
            exx
            do
...
jp PollVSync_
nextPlane1:
    ld a,c | add a,low(4000h-VramWidth*1) | ld c,a
    ld a,b | adc a,high(4000h-VramWidth*1) | ld b,a
    ld a,l | add a,CharHeight*2 | ld l,a
