...
constexpr byte GChar_Ghost = 0x41;
constexpr byte GChar_Chaser = 0x81;
constexpr byte GChar_Rock = 0x85;
constexpr byte GChar_Point = 0x89;
constexpr byte GChar_Loose = 0x99;
constexpr byte GChar_Box = 0xA1;
constexpr byte GChar_End = 0xA5;
