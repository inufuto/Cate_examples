...
constexpr byte Count = Sprite_EnemyBullet - Sprite_SkyEnemy;
...
static const word[] Paterns = { 
    GChar_SkyEnemyA, GChar_SkyEnemyB, GChar_SkyEnemyC
};
static const word[] DirectionPaterns = { 
    GChar_SkyEnemyB + 25 * 0,
    GChar_SkyEnemyB + 25 * 1,
    GChar_SkyEnemyB + 25 * 2,
    GChar_SkyEnemyB + 25 * 3,
    GChar_SkyEnemyB + 25 * 4,
    GChar_SkyEnemyB + 25 * 5,
    GChar_SkyEnemyB + 25 * 6,
    GChar_SkyEnemyB + 25 * 7,
};
    ...
    case Type_Smart: 
        {
            ...
            pEnemy->pattern = DirectionPaterns[pEnemy->direction];
