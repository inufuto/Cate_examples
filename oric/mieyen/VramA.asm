...
defb 2,Color_Yellow ; Dot
defb 4,Color_Yellow ; Food
defb 4,Color_Red ; FireBullet
defb 4,Color_Red ; Fire
defb 4,Color_White ; Remain
defb 4,Color_White ; Man
defb 16,Color_Magenta ; Monster
defb 0
InitVram: public InitVram
    ...
    ldx #Pattern_Ascii | ldy #Char_Ascii | lda #Char_Remain-Char_Ascii
    jsr SetPattern
