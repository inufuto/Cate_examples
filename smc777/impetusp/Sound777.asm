...
SoundHandler777: public SoundHandler777
    push hl | push de
        ld hl,(shootingTone)
        ld a,l
        or h
...
Sound_Fire777: public Sound_Fire777
...
smallExplosion_notes:
    defb 12,HighNoise, 0
Sound_SmallBang777: public Sound_SmallBang777
    push af | push hl
...
largeExplosion_notes:
    defb 24,LowNoise, 0
Sound_LargeBang777: public Sound_LargeBang777
    push af | push hl
...
Sound_Up777: public Sound_Up777
    push af | push hl
        ld hl,up_notes
        call Melody
    pop hl | pop af
...
over_notes: 
    ...
    defb N2P,E4, N4,0
    defb 0
Sound_GameOver777: public Sound_GameOver777
    push af | push hl
        ld hl,over_notes
        call MelodyWait
    pop hl | pop af
