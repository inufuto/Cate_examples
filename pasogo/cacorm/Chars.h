...
constexpr word Char_Remain = 0x5A;
constexpr word Char_Line = 0x5E;
constexpr word Char_Line_Normal = 0x5E;
constexpr word Char_Line_RightBottom = 0x5E;
constexpr word Char_Line_LeftBottom = 0x5F;
constexpr word Char_Line_RightTop = 0x60;
constexpr word Char_Line_LeftTop = 0x61;
constexpr word Char_Line_Left = 0x62;
constexpr word Char_Line_Right = 0x63;
constexpr word Char_Line_Top = 0x64;
constexpr word Char_Line_Bottom = 0x65;
constexpr word Char_Line_Red = 0x66;
...
constexpr byte PatternCount = 21;
