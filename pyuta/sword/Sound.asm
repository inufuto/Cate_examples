...
;   r1 : cycle
    ...
    ai r10,-2 | mov r2,*r10
        ...
        sla r2,8
        andi r2,>0f00
        ori r2,(>80 or Psg_ToneA) shl 8
        movb r2,@Port_Psg
        sla r1,4
        andi r1,>3f00
        movb r1,@Port_Psg
        li r1,(>80 or Psg_VolumeA) shl 8
        movb r1,@Port_Psg
    mov *r10+,r2
    mov *r10+,r1
rt
...
cseg
ToneOff:
    li r0,(8fh or Psg_VolumeA) shl 8
    movb r0,@Port_Psg
rt
...
; void Sound_Loose();
loose_notes:
    defb 1,F5, 1,E5, 1,D5, 1,C5, 1,B4, 1,A4, 1,G4, 1,F4, 0,0
...
StopBGM_: public StopBGM_
    ...
    dect r10 | mov r1,*r10
        ...
        li r0,3
        li r1,(Psg_VolumeB or 8fh) shl 8
        do
            movb r1,@Port_Psg
            ai r1,>2000
            dec r0
