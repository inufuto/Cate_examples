...
StagePane_: public StagePane_
    defs VramWidth*AsciiHeight
SpriteLayer_: public SpriteLayer_
    defs VramSize
pStatusPane: public pStatusPane
    defw 0
Param_pVram:
    defw 0
...
PresentVram_: public PresentVram_
    pha
        ...
        lda #low SpriteLayer_ | sta <pDestination
        lda #high SpriteLayer_ | sta <pDestination+1
        ...
        lda #low SpriteLayer_ | sta <pSource
        lda #high SpriteLayer_ | sta <pSource+1
