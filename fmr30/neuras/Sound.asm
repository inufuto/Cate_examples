...
start_notes: defb 3*2,C4, 3*2,G4, 3*2,E4, 3*2,G4, 12*2,C5, 0
...
clear_notes: defb 3*2,C4, 3*2,E4, 3*2,G4, 3*2,D4, 3*2,F4, 3*2,A4, 3*2,E4, 3*2,G4, 3*2,B4, 9*2,C5,0
...
over_notes: defb 3*2,C5, 3*2,G4, 3*2,E4, 3*2,C5,  3*2,B4, 3*2,G4, 3*2,E4, 3*2,B4,  6*2,A4, 6*2,B4,  12*2,C5, 0
...
BGM_B: 
    defb 3*2,D4, 3*2,F4, 3*2,G4
    defb 3*2,A4, 3*2,A4, 3*2,A4, 3*2,A4, 3*2,A4, 3*2,A4, 3*2,A4, 3*2,A4
    defb 3*2,G4, 3*2,G4, 3*2,G4, 3*2,G4, 3*2,G4, 3*2,G4, 3*2,A4, 3*2,G4
    defb 12*2,F4, 12*2,G4, 15*2,A4
    defb 3*2,D4, 3*2,F4, 3*2,G4
    defb 3*2,A4, 3*2,A4, 3*2,A4, 3*2,A4, 3*2,A4, 3*2,A4, 3*2,A4, 3*2,A4
    defb 3*2,G4, 3*2,G4, 3*2,G4, 3*2,G4, 3*2,G4, 3*2,G4, 3*2,A4, 3*2,G4
    defb 12*2,F4, 12*2,G4, 15*2,F4
    defb 0ffh
BGM_C: 
    defb 9*2,0
    defb 9*2,F3, 9*2,F3, 6*2,F3
    defb 9*2,C3, 9*2,C3, 6*2,C3
    defb 12*2,F3, 12*2,G3, (15+9)*2,A3
    defb 9*2,A3, 9*2,A3, 6*2,A3
    defb 9*2,G3, 9*2,G3, 6*2,G3
    defb 12*2,F3, 12*2,C3, 15*2,F3
    defb 0ffh
