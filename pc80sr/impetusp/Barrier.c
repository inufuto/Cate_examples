...
static void Show(ptr<Barrier> pBarrier)
{
    ...
    ShowSpriteXY(sprite, pBarrier->left, pBarrier->y, Char_BarrierLeft);
    ++sprite;
    ShowSpriteXY(sprite, pBarrier->right, pBarrier->y, Char_BarrierRight);
    ++sprite;
    ShowSpriteXY(sprite, pBarrier->center, pBarrier->y, Char_BarrierCenter);
}
