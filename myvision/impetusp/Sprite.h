...
extern void ShowSpriteXY(byte index, byte x, byte y, sbyte pattern, byte color);
extern void ShowSprite2(ptr<Movable> pMovable, byte pattern, byte color);
extern void HideSprite(byte index);
extern void HideSprite2(byte index);
