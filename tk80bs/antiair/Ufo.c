...
{
    const byte[] Chars = {
        0xc2, 0xcb, 0xcb, 0xc3, 0xc8, 0x20, 0x20, 0xc9,
    };
                ...
                if (x >= LeftSpace) {
                    ...
                    if (type != 0) {
                        ...
                        pLower = pUpper + VVramWidth;
                        {
                            ...
                            repeat (4) {
                                *pUpper = *pChars; ++pUpper;
                                ++pChars;
                            }
                        }
                        *pLower = Chars[4]; ++pLower;
                        if ((source & Ufo_TimeMask) == 0) {
                            byte c;
                            ptr<byte> pChars = BlockChars + 2 + ((type - 1) << 2);
                            *pLower = *pChars; ++pLower;
                            ++pChars;
                            *pLower = *pChars; ++pLower;
                        }
                        else {
