...
ClearScreen_: public ClearScreen_
    push psw | push h | push b
        di
            mvi a,0ffh | out PORTA
            ; mvi a,23h | out PORTB
            in PORTB | ori 03h  | out PORTB
            ...
            do
                push psw
                    ...
                    call WaitLCD
                    mvi a,32h | out LCDCOM ; counter mode
...
VVramToVram_: public VVramToVram_
    push psw | push h | push d | push b
        ...
        lxi h,Backup
        mvi a,VVramHeight/2 | sta yCount
        do
            mvi a,VVramWidth | sta xCount
            do
                ldax b | inx b
                cmp m
                if nz
