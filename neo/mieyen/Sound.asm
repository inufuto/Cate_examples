...
; void Sound_Start();
start_notes:
	defb 32,C4,1,0, 32,E4,1,0
	defb 15,G4,1,0, 32,E4,1,0, 32,F4,1,0
	defb 15,F4,1,0, 32,A4,1,0, 15,C5,1,0
	defb 49,A4,1,0, 99,C5,1,0
	defb 33,0
    defb 0
...
; void Sound_Clear();
clear_notes:
	defb 15,A4,1,0, 15,A4,1,0, 15,G4,1,0, 15,F4,1,0
	defb 15,G4,1,0, 32,A4,1,0, 32,B4,1,0
	defb 15,B4,1,0, 15,A4,1,0, 15,G4,1,0, 15,A4,1,0
	defb 32,B4,1,0, 82,C5,1,0
	defb 66,0
    defb 0
...
; void Sound_GameOver();
over_notes:
	defb 15,C5,1,0, 15,F4,1,0, 15,A4,1,0, 15,E4,1,0
	defb 15,G4,1,0, 15,A4,1,0, 15,B4,1,0, 15,C5,1,0
	defb 99,C5,1,0
	defb 33,0
    defb 0
...
BGM_B:
	defb 32,C4,1,0, 32,G4,1,0
	defb 15,C4,1,0, 32,G4,1,0, 32,A4,1,0
	defb 15,A4,1,0, 15,G4,1,0, 15,G4,1,0, 15,F4,1,0
	defb 15,F4,1,0, 15,E4,1,0, 15,E4,1,0, 32,D4,1,0
	defb 32,D4,1,0, 15,D4,1,0, 32,E4,1,0
	defb 49,D4,1,0, 100,0
	defb 32,C4,1,0, 32,G4,1,0
	defb 15,C4,1,0, 32,G4,1,0, 32,A4,1,0
	defb 15,A4,1,0, 15,G4,1,0, 15,G4,1,0, 15,F4,1,0
	defb 15,F4,1,0, 15,E4,1,0, 15,E4,1,0, 32,F4,1,0
	defb 32,F4,1,0, 15,F4,1,0, 32,A4,1,0
	defb 49,G4,1,0, 100,0
	defb 15,E4,1,0, 15,E4,1,0, 15,E4,1,0, 32,E4,1,0
	defb 15,E4,1,0, 32,A4,1,0, 15,D4,1,0
	defb 15,D4,1,0, 15,D4,1,0, 32,D4,1,0
	defb 15,D4,1,0, 32,G4,1,0, 16,0
	defb 15,A4,1,0, 16,0, 15,G4,1,0, 16,0
	defb 15,F4,1,0, 16,0, 15,E4,1,0, 32,D4,1,0
	defb 32,E4,1,0, 65,C4,1,0
    defb $ff
