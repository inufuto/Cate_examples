...
; void Sound_Start();
start_notes:
	defb 15,A4,1,0, 32,B4,1,0, 32,C5,1,0
	defb 32,C5,1,0, 15,A4,1,0, 32,D5,1,0
	defb 32,D5,1,0, 15,C5,1,0, 49,D5,1,0
	defb 99,E5,1,0
	defb 33,0
    defb 0
...
; void Sound_GameOver();
over_notes:
	defb 32,A4,1,0, 15,E4,1,0, 15,A4,1,0
	defb 15,G4,1,0, 15,F4,1,0, 15,E4,1,0, 15,D4,1,0
	defb 99,E4,1,0
	defb 33,0
    defb 0
...
BGM_B:
	defb 49,A4,1,0, 49,B4,1,0
	defb 65,C5,1,0
	defb 32,C5,1,0, 32,B4,1,0
	defb 32,C5,1,0, 49,B4,1,0
	defb 49,G4,1,0, 99,G4,1,0
	defb 66,0
	defb 49,A4,1,0, 49,B4,1,0
	defb 65,C5,1,0
	defb 32,C5,1,0, 32,B4,1,0
	defb 32,C5,1,0, 49,G5,1,0
	defb 49,D5,1,0, 99,D5,1,0
	defb 66,0
	defb 49,F5,1,0, 49,E5,1,0
	defb 65,F5,1,0
	defb 32,F5,1,0, 32,E5,1,0
	defb 32,F5,1,0, 49,E5,1,0
	defb 49,C5,1,0, 99,C5,1,0
	defb 66,0
	defb 15,A4,1,0, 15,A4,1,0, 15,B4,1,0, 32,C5,1,0
	defb 32,C5,1,0, 15,C5,1,0, 15,B4,1,0
	defb 15,B4,1,0, 15,C5,1,0, 32,D5,1,0
	defb 32,D5,1,0, 15,D5,1,0, 15,C5,1,0
	defb 15,C5,1,0, 15,D5,1,0, 32,E5,1,0
	defb 32,E5,1,0, 15,E5,1,0, 15,F5,1,0
	defb 32,F5,1,0, 49,E5,1,0
	defb 33,0
    defb $ff
