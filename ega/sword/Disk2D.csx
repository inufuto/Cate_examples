private const string LoaderName = "Loader2D.bin";
...
ReadLoader();
ReadProgram(name);
using (var stream = new FileStream(name + "_2d.d88", FileMode.Create))
{
...
using (var stream = new FileStream(name + "_2d.img", FileMode.Create))
{
    for (var i = 0; i < TrackCount; ++i)
    {
