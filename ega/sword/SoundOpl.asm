...
Inst_BD:
	...
	defb 01h,00h,0eh
Inst_SD:
	defb 05h,01h,00h,00h,0f8h or 0fh,0aah,59h,55h
	defb 00h,00h,01h
Inst_HH:
    defb 01h,01h,00h,00h or 67h,0c8h,0d8h,0a7h,68h
	defb 00h,00h,01h
RhythmTune:
    defb 150,0 ; BD
    defb 200,0 ; SD
...
Melody:
    cli
        mov [ChannelsOpl+unitSize*0+Channel_Ptr],ax
...
beep_notes:
    defb 1,A4, 0
Sound_AttackOpl: public Sound_AttackOpl
    push ax
        mov ax,beep_notes
        call Melody
    pop ax
...
up_notes:
    ...
    defb 0 
Sound_UpOpl: public Sound_UpOpl
    push ax
        mov ax,up_notes
        call Melody
    pop ax
...
BGM_D1:
    ...
    defb N8,F4, N8,0, N8,F4, N8,0, N8,G4, N8,0, N8,G4, N8,0  ;F G
...
BGM_D2:
    ...
    defb N8,C4, N8,0, N8,C4, N8,0, N8,D4 , N8,0, N8,D4, N8,0  ;F G
...
BGM_D3:
    ...
    defb N8,A3, N8,0, N8,A3, N8,0, N8,B3 , N8,0, N8,B3, N8,0  ;F G
