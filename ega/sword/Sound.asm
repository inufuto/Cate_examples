...
ext Sound_LooseBeep,Sound_HitBeep,Sound_UpBeep,Sound_AttackBeep,Sound_StartBeep,Sound_ClearBeep,Sound_GameOverBeep
ext StartBGMBeep, StopBGMBeep

ext InitSound1Opl,InitSound2Opl,SoundHandlerOpl
ext Sound_LooseOpl,Sound_HitOpl,Sound_UpOpl,Sound_AttackOpl,Sound_StartOpl,Sound_ClearOpl,Sound_GameOverOpl
ext StartBGMOpl, StopBGMOpl
...
InitSound1: public InitSound1
    ...
    if nz
        ...
        mov word ptr [Sound_Up_+1],Sound_UpOpl
        mov word ptr [Sound_Attack_+1],Sound_AttackOpl
...
SoundHandler: public SoundHandler
    defs 5
Sound_Loose_: public Sound_Loose_ defs 5
Sound_Hit_: public Sound_Hit_ defs 5
Sound_Up_:public Sound_Up_ defs 5
Sound_Attack_: public Sound_Attack_ defs 5
Sound_Start_: public Sound_Start_ defs 5
Sound_Clear_: public Sound_Clear_ defs 5
Sound_GameOver_: public Sound_GameOver_ defs 5
