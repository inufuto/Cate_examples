...
ext Sound_FireBeep,Sound_HitBeep,Sound_LooseBeep,Sound_UpBeep,Sound_StartBeep,Sound_GameOverBeep
ext StartBGMBeep, StopBGMBeep

ext InitSound1Opl,InitSound2Opl,SoundHandlerOpl
ext Sound_FireOpl,Sound_HitOpl,Sound_LooseOpl,Sound_UpOpl,Sound_StartOpl,Sound_GameOverOpl
...
Sound_Fire_: public Sound_Fire_ defs 5
