...
constexpr byte GroundWidth = WindowWidth / TileSize;
constexpr byte GroundHeight = (WindowHeight + TileSize * 2 - 1) / TileSize;
...
void InitTrying()
{
    ...
    FillMemory(Ground + GroundWidth * 2, GroundWidth * (GroundHeight - 2), 5);
}
