...
cseg
PaletteValues:
	defb	00h, 00h, 0fbh, 2ch, 00h, 7ch, 7bh, 7eh
	defb	0e0h, 03h, 0ffh, 5fh, 0e0h, 7fh, 0ffh, 7fh
	defb	00h, 00h, 0efh, 3dh, 67h, 4dh, 0efh, 6dh
	defb	0e0h, 01h, 73h, 01h, 0f3h, 6eh, 0f7h, 5eh
...
VVramToVram_: public VVramToVram_
    push af | push hl | push de | push bc
        ...
        do
            ...
            dwnz
            push de
                ld de,VramRowSize-VVramWidth | add hl,de
            pop de
            dec c
        while nz | wend
