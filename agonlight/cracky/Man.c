...
static const Direction[] DirectionTable = {
    { Keys_Left, Pattern_Man_Left - Pattern_Man, -1, 0 },
    { Keys_Right, Pattern_Man_Right - Pattern_Man, 1, 0 },
    { Keys_Up, Pattern_Man_UpDown - Pattern_Man, 0, -1 },
    { Keys_Down, Pattern_Man_UpDown - Pattern_Man, 0, 1 },
};
...
static void Show()
{
    ...
    if ((Man.status & Movable_Fall) == 0) {
        if (pattern == Pattern_Man_UpDown - Pattern_Man) {
            byte seq;
