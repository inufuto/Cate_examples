...
{
    if (ManX < WindowWidth / 2) {
        BaseX = 0;
    }
    else {
        byte x, margin;
        margin = MapWidth - WindowWidth;
        x = ManX - WindowWidth / 2;
        if (x >= margin) {
            BaseX = margin;
        }
        else {
    ...
    if (ManY < WindowHeight / 2) {
        BaseY = 0;
    }
    else {
        byte y, margin;
        margin = MapHeight - WindowHeight;
        y = ManY - WindowHeight / 2;
        if (y >= margin) {
            BaseY = margin;
        }
        else {
