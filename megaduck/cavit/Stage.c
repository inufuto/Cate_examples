...
void DrawTerrain(byte x, byte y, byte terrain)
{
    ...
    if (t == Terrain_Space) {
        static const byte[] Codes = {
            ...
            Char_Wall_Left, Char_Space, Char_Wall_Left, Char_Space, 
            Char_Space, Char_Wall_Right, Char_Space, Char_Wall_Right, 
            Char_Wall_Left, Char_Wall_Right, Char_Wall_Left, Char_Wall_Right, 
            Char_Wall_Top, Char_Wall_Top, Char_Space, Char_Space, 
            Char_Wall_LeftTop, Char_Wall_Top, Char_Wall_Left, Char_Space, 
            Char_Wall_Top, Char_Wall_RightTop, Char_Space, Char_Wall_Right, 
            Char_Wall_LeftTop, Char_Wall_RightTop, Char_Wall_Left, Char_Wall_Right, 
            Char_Space, Char_Space, Char_Wall_Bottom, Char_Wall_Bottom, 
            Char_Wall_Left, Char_Space, Char_Wall_LeftBottom, Char_Wall_Bottom, 
            Char_Space, Char_Wall_Right, Char_Wall_Bottom, Char_Wall_RightBottom, 
        ...
        static const byte[] Codes = {
            ...
            Char_Bedrock, Char_Bedrock + 2, Char_Bedrock + 1, Char_Bedrock + 3,
            0, 0, 0, 0,
            Char_Soil + 2, Char_Soil + 3, Char_Soil + 1, Char_Soil,
        };
        if (t == 1 && y == 1) {
            t = 4;
        }
...
{
    word vram;
    vram = VramAddress(x << 1, (y << 1) + StageTop);
    Put2S(vram, pChars);
}
