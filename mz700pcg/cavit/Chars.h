...
constexpr byte Char_Ghost = 0x80;
constexpr byte Char_Soil = 0xA0;
constexpr byte Char_Bedrock = 0xA2;
constexpr byte Char_Cent = 0xA3;
constexpr byte Char_Wall = 0xA4;
constexpr byte Char_Man = 0xAC;
constexpr byte Char_Loose = 0xEC;
...
constexpr byte Char_Reverse = 0x40;
