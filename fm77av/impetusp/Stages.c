...
const Tile[] Tiles = {
	...
	{ // 24
		{ // chars
			Char_Terrain + 8, Char_Terrain + 10, Char_Terrain + 10, Char_Terrain + 11, 
	...
	{ // 26
		{ // chars
			...
			Char_Terrain + 3, Char_Terrain + 3, Char_Terrain + 3, Char_Terrain + 3, 
			Char_Terrain + 5, Char_Terrain + 3, Char_Terrain + 3, Char_Terrain + 3, 
		},
	},
	{ // 27
		{ // chars
	...
	{ // 30
		{ // chars
			Char_Terrain + 12, Char_Terrain + 0, Char_Terrain + 0, Char_Terrain + 6, 
			Char_Terrain + 0, Char_Terrain + 0, Char_Terrain + 0, Char_Terrain + 0, 
			Char_Terrain + 0, Char_Terrain + 0, Char_Terrain + 0, Char_Terrain + 0, 
			Char_Terrain + 11, Char_Terrain + 0, Char_Terrain + 0, Char_Terrain + 8, 
		},
	},
	{ // 31
		{ // chars
	...
	{ // 33
		{ // chars
			...
			Char_Terrain + 10, Char_Terrain + 10, Char_Terrain + 10, Char_Terrain + 10, 
			Char_Terrain + 10, Char_Terrain + 10, Char_Terrain + 10, Char_Terrain + 10, 
			Char_Terrain + 6, Char_Terrain + 10, Char_Terrain + 10, Char_Terrain + 12, 
		},
	},
	{ // 34
		{ // chars
	...
	{ // 39
		{ // chars
			Char_Terrain + 9, Char_Terrain + 0, Char_Terrain + 0, Char_Terrain + 5, 
			Char_Terrain + 0, Char_Terrain + 0, Char_Terrain + 0, Char_Terrain + 0, 
			Char_Terrain + 0, Char_Terrain + 0, Char_Terrain + 0, Char_Terrain + 0, 
			Char_Terrain + 0, Char_Terrain + 0, Char_Terrain + 0, Char_Terrain + 0, 
		},
	...
	{ // 41
		{ // chars
			...
			Char_Terrain + 3, Char_Terrain + 3, Char_Terrain + 3, Char_Terrain + 3, 
			Char_Terrain + 3, Char_Terrain + 3, Char_Terrain + 3, Char_Terrain + 3, 
			Char_Terrain + 5, Char_Terrain + 3, Char_Terrain + 3, Char_Terrain + 9, 
		},
	},
	{ // 42
		{ // chars
	...
	{ // 43
		{ // chars
			...
			Char_Terrain + 3, Char_Terrain + 3, Char_Terrain + 3, Char_Terrain + 3, 
			Char_Terrain + 3, Char_Terrain + 3, Char_Terrain + 3, Char_Terrain + 3, 
			Char_Terrain + 3, Char_Terrain + 3, Char_Terrain + 3, Char_Terrain + 9, 
		},
	},
	{ // 44
		{ // chars
...
static const byte[] mapBytes0 = {
	...
	29, 128 + 5, 0, 128 + 3, 36, 44, 40, 128 + 3, 
	0, 34, 36, 36, 44, 44, 4, 0, 
	0, 12, 34, 36, 44, 44, 40, 0, 
	6, 10, 12, 34, 128 + 3, 44, 4, 22, 
	47, 0, 0, 128 + 3, 44, 40, 4, 128 + 3, 
	0, 128 + 4, 44, 40, 4, 0, 25, 128 + 5, 
	44, 40, 4, 34, 128 + 6, 44, 40, 4, 
	128 + 11, 44, 38, 15, 128 + 18, 44, 37, 128 + 6, 
	44, 43, 0, 44, 44, 43, 37, 128 + 3, 
	0, 6, 14, 41, 37, 0, 25, 32, 
...
static const byte[] mapBytes1 = {
	...
	128 + 3, 44, 0, 27, 128 + 6, 44, 0, 128 + 7, 
	44, 2, 128 + 25, 44, 37, 14, 128 + 6, 44, 
	4, 2, 44, 44, 43, 37, 128 + 6, 44, 
	37, 0, 128 + 6, 44, 4, 0, 128 + 16, 44, 
	0, 14, 42, 128 + 5, 44, 0, 0, 14, 
	42, 128 + 4, 44, 128 + 3, 0, 14, 42, 128 + 3, 
	44, 0, 0, 25, 32, 14, 44, 43, 
	37, 0, 0, 34, 35, 0, 44, 37, 
	128 + 6, 0, 44, 0, 0, 5, 128 + 4, 8, 
	45, 8, 8, 16, 0, 25, 32, 0, 
	44, 25, 36, 16, 0, 34, 35, 0, 
	44, 36, 36, 16, 128 + 4, 0, 44, 36, 
	36, 16, 128 + 4, 0, 44, 34, 36, 16, 
	128 + 4, 0, 44, 0, 0, 18, 8, 8, 
	9, 8, 45, 8, 8, 16, 0, 0, 
	16, 2, 44, 0, 0, 46, 44, 44, 
	46, 44, 43, 0, 25, 16, 0, 0, 
...
static const byte[] mapBytes2 = {
	...
	36, 32, 128 + 3, 0, 2, 27, 44, 36, 
	35, 0, 27, 128 + 4, 44, 128 + 3, 0, 128 + 5, 
	44, 32, 0, 2, 128 + 5, 44, 35, 0, 
	27, 128 + 5, 44, 0, 2, 128 + 6, 44, 0, 
	26, 128 + 6, 44, 0, 15, 128 + 6, 44, 0, 
	27, 128 + 6, 44, 0, 128 + 7, 44, 0, 42, 
	128 + 6, 44, 0, 14, 42, 128 + 5, 44, 36, 
	32, 0, 14, 42, 128 + 3, 44, 36, 35, 
	0, 0, 14, 42, 44, 44, 8, 8, 
	7, 0, 0, 14, 44, 44, 0, 0, 
	16, 0, 25, 32, 44, 37, 0, 0, 
	16, 0, 34, 36, 44, 0, 32, 0, 
	16, 128 + 3, 0, 44, 0, 36, 0, 18, 
	128 + 3, 8, 45, 8, 36, 0, 16, 0, 
	25, 32, 44, 0, 36, 0, 16, 0, 
	34, 36, 44, 0, 36, 0, 16, 128 + 3, 
	0, 44, 0, 35, 0, 16, 128 + 3, 0, 
	44, 128 + 3, 0, 18, 8, 9, 8, 45, 
	8, 0, 0, 16, 0, 16, 2, 44, 
	0, 44, 44, 46, 44, 46, 44, 43, 
...
static const byte[] mapBytes3 = {
	...
	3, 0, 18, 8, 0, 0, 34, 36, 
	32, 0, 16, 0, 40, 4, 12, 34, 
	35, 0, 16, 0, 44, 40, 4, 128 + 3, 
	0, 16, 0, 128 + 6, 44, 46, 44, 44, 
	43, 37, 128 + 3, 0, 16, 0, 44, 37, 
	0, 0, 5, 8, 21, 8, 43, 128 + 3, 
...
static const byte[] mapBytes4 = {
	...
	27, 128 + 3, 44, 40, 4, 0, 128 + 51, 44, 
	43, 39, 42, 128 + 5, 44, 37, 0, 14, 
	128 + 5, 44, 4, 0, 2, 128 + 34, 44, 14, 
	42, 44, 44, 43, 37, 14, 42, 0, 
	14, 44, 43, 37, 128 + 5, 0, 44, 37, 
	128 + 6, 0, 44, 128 + 5, 0, 8, 8, 45, 
	128 + 5, 8, 32, 0, 44, 25, 36, 36, 
	32, 0, 35, 0, 44, 128 + 4, 36, 128 + 3, 
	0, 44, 128 + 4, 36, 128 + 3, 0, 44, 34, 
	36, 36, 35, 0, 5, 8, 45, 128 + 5, 
	8, 16, 2, 44, 128 + 5, 0, 46, 44, 
	43, 0, 0, 6, 10, 0, 16, 0, 
	0, 24, 0, 23, 48, 0, 16, 0, 
...
static const byte[] mapBytes5 = {
	...
	36, 40, 0, 6, 10, 12, 34, 36, 
	36, 44, 4, 22, 47, 128 + 4, 0, 44, 
	40, 4, 128 + 5, 0, 44, 44, 40, 4, 
	0, 0, 25, 36, 128 + 3, 44, 40, 4, 
	0, 34, 36, 128 + 4, 44, 40, 4, 12, 
	34, 128 + 5, 44, 40, 4, 0, 44, 38, 
	15, 128 + 10, 44, 43, 37, 0, 128 + 5, 44, 
	37, 0, 0, 128 + 4, 44, 43, 128 + 3, 0, 
	43, 37, 128 + 3, 0, 6, 10, 128 + 3, 0, 
...
static const byte[] mapBytes6 = {
	...
	44, 44, 0, 0, 16, 0, 0, 15, 
	44, 44, 0, 0, 16, 0, 0, 27, 
	44, 44, 8, 8, 20, 0, 0, 128 + 3, 
	44, 0, 0, 16, 0, 0, 42, 44, 
	44, 0, 0, 16, 0, 0, 14, 42, 
	44, 0, 0, 16, 0, 25, 32, 128 + 4, 
	0, 16, 0, 34, 35, 0, 0, 8, 
...
static const byte[] mapBytes7 = {
	...
	35, 128 + 9, 0, 128 + 8, 44, 128 + 10, 0, 5, 
