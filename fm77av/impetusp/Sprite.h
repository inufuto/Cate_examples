...
extern void ShowSprite1(ptr<Movable> pMovable, byte c);
extern void ShowSprite2(ptr<Movable> pMovable, byte c);
extern void ShowSpriteXY(byte index, byte x, byte y, byte c);
