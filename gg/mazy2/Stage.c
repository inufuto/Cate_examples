...
void InitFloor()
{
    ...
    }
    {
        static const byte[] Chars = {
            ...
            Char_StairUp, Char_StairUp + 2, Char_StairUp + 1, Char_StairUp + 3,
            Char_StairDown, Char_StairDown + 2, Char_StairDown + 1, Char_StairDown + 3,
            Char_Goal, Char_Goal + 2, Char_Goal + 1, Char_Goal + 3,
        };
