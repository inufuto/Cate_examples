...
void Title()
{
    ...
    PrintStatus();
    {
        ...
        PrintS(Vram + VramRowSize * 10 + (LogoLeft + LogoWidth - 5) * VramStep, "MICRO");
    }
    PrintS(Vram + VramRowSize * 12 + 5 * VramStep, "1:START");
    PrintS(Vram + VramRowSize * 13 + 5 * VramStep, "2:CONTINUE");
    PrintS(Vram + VramRowSize * 15 + 8 * VramStep, "INUFUTO 2026");
    // {
