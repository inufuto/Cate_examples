...
VdpValues:
    defb 16h,0e2h
    defb 0ffh,0ffh,0ffh,0ffh,0ffh,00h
    defb 00h,00h,0ffh
ColorValues:
	defb 00h,00h,00h,0fh,0fh,00h,0afh,0fh
	defb 0afh,00h,0ffh,0fh,0ffh,00h,0f0h,0fh
	defb 0a0h,0fh,0fh,00h,0ffh,00h,05h,05h
	defb 0f0h,00h,00h,00h,5fh,05h,0afh,0ah
