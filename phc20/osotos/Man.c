...
static const Direction[] Directions = {
    { Keys_Left, -1, 0, (Char_Man_Left - Char_Man) / 4 },
    { Keys_Right, 1, 0, (Char_Man_Right - Char_Man) / 4 },
    { Keys_Up, 0, -1, (Char_Man_UpDown - Char_Man) / 4 },
    { Keys_Down, 0, 1, (Char_Man_UpDown - Char_Man) / 4},
};
