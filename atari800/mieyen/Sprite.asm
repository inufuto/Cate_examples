...
Sprite_End equ 13
SpriteCount equ Sprite_End-1

PlayerHeight equ 256
TopY equ 17
MaxY equ PlayerHeight-TopY-SpriteHeight+1
LeftX equ 64
RowHeight equ 8 
...
MakePatternAddress:
    pha
        lda #0 | sta <ZW1+1
        lda ShowSprite_pattern_
        and #$7f
        asl a | rol <ZW1+1 ;*2
        asl a | rol <ZW1+1 ;*4
        asl a | rol <ZW1+1 ;*8
        asl a | rol <ZW1+1 ;*16
        clc|adc #low SpritePattern | sta <ZW1
        ...
        if eq
            ...
            if cc
                ...
                sei
                    ...
                    ; ora <ZB0
                    sta Sprites_x,x
                    lda ShowSprite_color_ | sta Sprites_color,x
