...
{
    constexpr byte Color = 6;
    byte sprite = pBarrier->sprite;
    ShowSpriteXY(sprite, pBarrier->left, pBarrier->y, Pattern_BarrierLeft, Color);
    ++sprite;
    ShowSpriteXY(sprite, pBarrier->right, pBarrier->y, Pattern_BarrierRight, Color);
    ++sprite;
    ShowSpriteXY(sprite, pBarrier->center, pBarrier->y, Pattern_BarrierCenter, Color);
}
