constexpr word Vram_PatternGenerator = 0x0000 | 0x4000;
constexpr word Vram_PatternName = 0x1800 | 0x4000;
constexpr word Vram_SpriteAttribute = 0x1b00 | 0x4000;
constexpr word Vram_Color = 0x2000 | 0x4000;
constexpr word Vram_SpriteGenerator = 0x3800 | 0x4000;
...
extern void UpdateBackgroundChars();
