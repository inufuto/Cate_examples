...
;     lda CopyMemory_pDestination | sta <pDestination
;     lda CopyMemory_pDestination+1 | sta <pDestination+1
...
FillMemory_ : public FillMemory_
    lda FillMemory_pDestination | sta <pDestination
    lda FillMemory_pDestination+1 | sta <pDestination+1
