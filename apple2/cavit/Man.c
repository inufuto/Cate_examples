...
static const byte[] MidChars = {
    Char_Wall_RightTop, Char_Soil, Char_Wall_RightBottom, Char_Soil, 
    Char_Soil, Char_Wall_LeftTop, Char_Soil, Char_Wall_LeftBottom, 
    Char_Wall_LeftBottom, Char_Wall_RightBottom, Char_Soil, Char_Soil, 
    Char_Soil, Char_Soil, Char_Wall_LeftTop, Char_Wall_RightTop, 
};
