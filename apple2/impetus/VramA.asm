...
VVramToVramAll_: public VVramToVramAll_
    lda #low Vram | sta <VVramToVram_pVram
    lda #high Vram | sta <VVramToVram_pVram+1
...
StatusToVram_: public StatusToVram_
    ...
    lda #low Status_ | sta <VVramToVram_pVVram
    lda #high Status_ | sta <VVramToVram_pVVram+1
