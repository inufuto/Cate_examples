...
ext VVramFront_, RowFlags_, Chars_
; ext CharColors_
...
Print1:
    ...
    do
        ...
        lda (Print1_pVram,x)
        and leftMask | ora Print1_leftByte | and #$7f | ora #$80 ;ColorBit
        sta (Print1_pVram,x)
        inc Print1_pVram
        ...
        lda (Print1_pVram,x)
        and rightMask | ora Print1_rightByte | and #$7f | ora #$80  ;ColorBit
        sta (Print1_pVram,x)
        dec Print1_pVram
...
VVramToVram_pVVram equ Zp.TmpX0
VVramToVram_pBackup equ Zp.Word
VVramToVram_pVram equ Zp.Byte3
VVramToVram_flagsOffset equ Zp.Counter1
VVramToVram_bit equ Zp.X
VVramToVram_flags equ Zp.Y
dseg
VVramToVram_yCount:
    defb 0
cseg
...
VVramToVramAll_: public VVramToVramAll_
    ...
    lda #low VVramFront_ | sta VVramToVram_pVVram
    lda #high VVramFront_ | sta VVramToVram_pVVram+1

    lda #low Backup_ | sta VVramToVram_pBackup
    lda #high Backup_ | sta VVramToVram_pBackup+1

    lda #VVramHeight
    sta VVramToVram_yCount
    do
        jsr VVramToVramRow
