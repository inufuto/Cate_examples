...
Sound_Push:
    lda #low push_notes | sta Zp.TmpX0.low
    lda #high push_notes | sta Zp.TmpX0.high
jmp Melody
Sound_Push_:  public Sound_Push_
    lda #low Sound_Push | sta SoundProc_
    lda #high Sound_Push | sta SoundProc_+1
rts
...
Sound_Beep_:  public Sound_Beep_
    lda #low beep_notes | sta Zp.TmpX0.low
    lda #high beep_notes | sta Zp.TmpX0.high
jmp Melody
